...
// @version      0.2.22
// @description  List wanted items and highlight them on the scavenge wheel. Supports regex.
// @author       pseudoical
...
(async function () {
    ...
    const observer = new MutationObserver(async (mutations) => {
        for (const mutation of mutations) {
            ...
            // Mutations occur when standing over items; throttle for performance
