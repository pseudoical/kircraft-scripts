...
// @version      0.2.22
// @description  Automatically show inventory when going to a new location.
// @author       pseudoical
...
(async function () {
    ...
    await debug(`getElementById("inv-panel")`, async () => {
        await getElement(() => document.getElementById("inv-panel"));
    });
    ...
    const event = new KeyboardEvent("keydown", { code: keybinds.inventory });
