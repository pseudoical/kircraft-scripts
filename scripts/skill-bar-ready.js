// ==UserScript==
// @name         Skill Bar Ready
// @namespace    https://kircraft.io/
// @version      0.2.22
// @description  Outline skill slot green when ready.
// @author       pseudoical
...
(function () {
    ...
    style.textContent = `
        /* Remove slot number and name */
        #skill-bar :is(.slot-key, .slot-name) {
            display: none !important;
        }

        /* Remove yellow tint on recently used skill */
        .skill-slot.active {
            background: rgba(0,0,0,.7) !important;
        }

        .skill-slot:has(.slot-cd[style*="height: 0%"]) {
